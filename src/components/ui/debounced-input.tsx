...
import { Input, InputProps } from './input'; // Assuming InputProps is exported or use React.ComponentProps<'input'>
...
const DebouncedInput = React.forwardRef<HTMLInputElement, DebouncedInputProps>(
    ({ initialValue = '', onDebouncedChange, debounceTimeout = 500, ...props }, ref) => {
        ...
        }, [inputValue, onDebouncedChange, debounceTimeout]); // Rerun effect if these changes
