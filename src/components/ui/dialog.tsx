...
/*
TODO: This is the old approach, the new approach is to use the forwardRef function
...
function DialogContent({ className, children, ...props }: React.ComponentProps<typeof DialogPrimitive.Content>) {
    ...
    const handleInteractOutside = React.useCallback((event: CustomEvent<{ originalEvent: Event }>) => {
        const target = event.detail.originalEvent.target as Element;
