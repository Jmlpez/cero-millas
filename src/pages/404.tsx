        ...
        <>
            <div className="relative z-1 flex min-h-screen flex-col items-center justify-center overflow-hidden p-6">
                ...
                <div className="mx-auto w-full max-w-[242px] text-center sm:max-w-[472px]">
                    <h1 className="text-title-md xl:text-title-2xl mb-8 font-bold text-gray-800 dark:text-white/90">{t('pages.notFound.title')}</h1>
                    ...
                    <p className="mt-10 mb-6 text-base text-gray-700 sm:text-lg dark:text-gray-400">{t('pages.notFound.description')}</p>
                ...
                <p className="absolute bottom-6 left-1/2 -translate-x-1/2 text-center text-sm text-gray-500 dark:text-gray-400">
                    &copy; {new Date().getFullYear()} - 89millas
                </p>
            </div>
        </>
    );
