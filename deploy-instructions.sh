...
echo "   - Repository name: cero-millas"
...
echo "   git remote add origin https://github.com/YOUR_USERNAME/cero-millas.git"
...
echo "   https://YOUR_USERNAME.github.io/cero-millas/"
echo ""
